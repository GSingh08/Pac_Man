...
let scoreCount = () => {
  ...
  let addScore = 1;
  var newScore = Number(currentScore) + addScore;
...
//THIS FUNCTION GIVES YOU AN ALERT WHEN PACMAN EATS UPS ALL THE DOTS
let gameOver = () => {
  if (document.getElementsByClassName("dot").length === 0) {
    // document.getElementById("You-Win").style.display = ;
    alert("You Win!");
  }
};
gameOver();
